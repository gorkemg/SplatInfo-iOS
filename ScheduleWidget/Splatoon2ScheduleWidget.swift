...
struct Previews_Splatoon2ScheduleWidget_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        Splatoon2TimelineProvider.ScheduleEntryView(entry: Splatoon2TimelineProvider.GameModeEntry(date: Date(), events: .coopEvents(events: schedule.coop.events, timeframes: schedule.coop.otherTimeframes, gear: schedule.coop.gear), configuration: Splatoon2_ScheduleIntent()))
            .previewContext(WidgetPreviewContext(family: .systemMedium))
        #endif
    }
}
